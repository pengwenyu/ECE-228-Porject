...
# from image import *
from utils.utilss import merge_bboxes
# from utils import merge_bboxes
import sys
#sys.path.append('yolov4-TT100k')
#qq = plt.imread('train/43.jpg')
#plt.imshow(qq)
#plt.show()
#with open('yolov4-TT100k/annotations/TT100K_CoCo_format_train.json') as f:
#    f.readline()
print('*'*60)
# TT100k 221
class COCO(Dataset):
    def __init__(self, data_dir, image_size=(608, 608), mosaic=True):
        ...
        path_to_anno = 'yolov4-TT100k/'
        self.data_dir = path_to_anno#data_dir #Modify here

        self.annot_path = os.path.join(self.data_dir, "annotations/TT100K_CoCo_format_train.json")
        self.img_dir = os.path.join("train")
...
class COCOEval(COCO):
    def __init__(self, data_dir, image_size=(416, 416)):
        ...
        self.annot_path = os.path.join(self.data_dir, "annotations/",'TT100K_CoCo_format_test.json')
        self.img_dir = os.path.join("test")
